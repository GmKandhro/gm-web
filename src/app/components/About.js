...
const About = () => {
  ...
  return (
   ...
   <main className='flex flex-col  justify-between shadow-2xl lg:flex-row p-6 rounded-2xl mt-20  bg-[#161f33] text-white'>
   <div className='w-auto lg:w-[500px] mb-[0] lg:mb-4 flex flex-col '>
   ...
   <div>
    <div className='flex gap-4 text-white font-semibold text-[19px]'>
    ...
    </div>
    {
      about.map((item , index)=>(
        <p key={item.text} className='w-auto lg:w-[600px] mt-2'>{item.text}</p>
      ))
    }
   </div>
   </main>
